...
document.getElementById('downloadForm').addEventListener('submit', async function(event) {
    ...
    if (response.ok) {
        ...
        a.href = url;
        a.download = 'Video.mp4'; // You can set a specific file name here if needed
...
const translations = {
    en: {
        ...
        footerNote: "© 2024 YouTube Downloader, made with ❤️ by @SaiDivakar.",
    ...
    te: {
        ...
        step4: "దశ 4: డౌన్లోడ్",
        footerNote: "© 2024 యూట్యూబ్ డౌన్లోడర్, ❤️తో చేసినది @SaiDivakar.",
    ...
    hi: {
        ...
        footerNote: "© 2024 YouTube Downloader, ❤️ के साथ बनाया गया @SaiDivakar द्वारा।",
    ...
    ta: {
        ...
        footerNote: "© 2024 YouTube Downloader, ❤️ உடன் உருவாக்கப்பட்டது @SaiDivakar.",
    ...
    bn: {
        ...
        footerNote: "© 2024 ইউটিউব ডাউনলোডার, ❤️ দিয়ে তৈরি @SaiDivakar।",
    ...
    es: {
        ...
        footerNote: "© 2024 YouTube Downloader, hecho con ❤️ por @SaiDivakar.",
    ...
    fr: {
        ...
        footerNote: "© 2024 YouTube Downloader, créé avec ❤️ par @SaiDivakar.",
    ...
    de: {
        ...
        footerNote: "© 2024 YouTube Downloader, erstellt mit ❤️ von @SaiDivakar.",
        shortsDownloader: "YouTube Shorts Downloader",
    ...
    zh: {
        ...
        step3: "步骤 3: 点击“下载”按钮",
        step4: "步骤 4: 下载",
        footerNote: "© 2024 YouTube 下载器，由 @SaiDivakar ❤️ 制作。",
    ...
    it: {
        ...
        footerNote: "© 2024 YouTube Downloader, fatto con ❤️ da @SaiDivakar.",
        shortsDownloader: "YouTube Shorts Downloader",
    ...
    ru: {
        ...
        footerNote: "© 2024 YouTube Downloader, сделано с ❤️ @SaiDivakar.",
    ...
    ja: {
        ...
        step4: "ステップ4: ダウンロード",
        footerNote: "© 2024 YouTube Downloader, ❤️で作成 @SaiDivakar.",
    ...
    ko: {
        ...
        step4: "4단계: 다운로드",
        footerNote: "© 2024 유튜브 다운로더, ❤️로 제작됨 @SaiDivakar.",
    ...
    ar: {
        ...
        footerNote: "© 2024 مُحمّل يوتيوب، تم صنعه بحب ❤️ من @SaiDivakar.",
